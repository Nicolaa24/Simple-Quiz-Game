  ...
  return (
    <div className='w-screen h-screen bg-amber-200 '>
      ...
      <div className={explanation ? 'opacity-0' : ' w-[400px] m-auto mt-7 bg-slate-400 py-4 px-7 rounded-lg'}>
        ...
        You have 10 questions that need to be answered. You have 30 seconds to choose your answer, if you dont the question will be automatically switched. There is also good news! You have 4 hints, 2 of which are 50/50. At the end of the game you can see your score and the best players.
        Good luck!
      </div>
    </div>
  )
